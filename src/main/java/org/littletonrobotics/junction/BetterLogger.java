...
public class BetterLogger {
    ...
    private static BetterLogger instance = new BetterLogger();
    ...
    public static void setReplaySource(LogReplaySource replaySource) {
        if (!running) {
            BetterLogger.replaySource = replaySource;
        }
    }
    ...
    static void periodicAfterUser(long userCodeLength, long periodicBeforeLength) {
        if (running) {
            ...
            try {
                ...
                receiverQueue.add(BetterLogTable.clone(entry));
        ...
        MathSharedStore.setMathShared(
                new MathShared() {
                    ...
                    public double getTimestamp() {
                        return (mocked ? BetterLogger.getTimestamp() : BetterLogger.getRealTimestamp()) * 1.0e-6;
                    }
                });
    }
