...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Turn to Speaker", new ConditionalCommand(
      ...
      DriveCommands.turnToTargetCommand(driveBase, new Translation2d(Units.inchesToMeters(-1.5), Units.inchesToMeters(218.42)), 4.5),
      // Turn to Red Speaker.
      DriveCommands.turnToTargetCommand(driveBase, new Translation2d(Units.inchesToMeters(652.73), Units.inchesToMeters(218.42)), 4.5),
