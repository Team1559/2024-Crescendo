...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    controller1.a().onTrue(CalibrationUtils.calibrateSpinStep(driveBase, Rotation2d.fromDegrees(45), 1));
    controller1.b().onTrue(CalibrationUtils.calibrateSpinStep(driveBase, Rotation2d.fromDegrees(15), 2));
    controller1.x().onTrue(CalibrationUtils.calibrateSpin(driveBase));
  }
